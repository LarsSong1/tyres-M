      ...
      <div className='container-fluid cont-nosotros pt-5 pb-5 mx-auto'>
        <div>
          ...
          <div className='nosotros-texto d-flex justify-content-between align-items-center mt-5 mb-5 flex-wrap'>
            ...
            <p className='col-12 col-md-6 col-lg-6'><strong>Tyres&M</strong> <br />
            Somos un negocio ubicado en la provincia de Santa Elena -Ecuador comprometido a satisfacer las necesidades del cliente por medio de la comercializacion de servicios de reencauche, cambios de banda, venta de Tubos, Aros, válvulas y sobre todo llantas con altos estándares de calidad y compromiso en cuanto a los requisitos legales.
            <br />
            Tyres&M se compromete con el cliente final para brindarle la asesoria necesaria sobre el producto que desea adquiri. 
            <br />
